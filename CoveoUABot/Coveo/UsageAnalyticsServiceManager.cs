...
{
    public class UsageAnalyticsServiceManager : ServiceManagerBase
    {
        /// <summary>
        ...
        public UsageAnalyticsServiceManager(
        ...
        /// <inheritdoc />
        public UsageAnalyticsQueryResponse LogUsageAnalytics(
            UsageAnalyticsQueryRequest query, string type,
            CancellationToken cancellationToken)
        {
            return this.ExecuteRequest<UsageAnalyticsQueryResponse, Error>(new UsageAnalyticsRequest(this.Config, query, type).Build(), cancellationToken).ResponseObject;
        }
    }
}